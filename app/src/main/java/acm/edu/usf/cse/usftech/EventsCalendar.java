...
public class EventsCalendar extends AppCompatActivity
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_report) {
            ...
            try {
                ...
                Toast.makeText(EventsCalendar.this, "There is no email client installed.", Toast.LENGTH_LONG).show();
            }
    ...
    public static class PlaceholderFragment extends Fragment {
        ...
        public void onAttach(Activity activity) {
            ...
            ((EventsCalendar) activity).onSectionAttached(
    ...
    public static class EventsFragment extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            if(!gotEvents) {    //Events not retrieved, this if statement ensures against duplication
                ...
                attachEvents(getContext(), rootView);
            }
            gotEvents = true;
        ...
        protected void attachEvents(Context context, View rootView) {
            ...
            EventAdapter adapter = new EventAdapter(context, R.layout.events_list_item, events);
        ...
        private class getEvents extends AsyncTask<String, Void, Document> {
            ...
            protected void onPostExecute(Document result) {
                ...
                rootNode = removeTextNodes(rootNode);   //Remove all text nodes from node tree
                ...
                attachEvents(mContext, rootView);
            }

            /* Recursive function to remove all text nodes from a given node tree */
            private Node removeTextNodes(Node root) {
    ...
    public static class JobsFragment extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            if(!gotJobs) {    //Events not retrieved, this if statement ensures against duplication
                ...
                attachJobs(getContext(), rootView);
            }
            gotJobs = true;
        ...
        protected void attachJobs(Context context, View rootView) {
            /* Attach the ArrayList of events to the ListView using a custom adapter */
            ListView jobList = (ListView) rootView.findViewById(R.id.listJobs);
            JobAdapter adapter = new JobAdapter(context,R.layout.jobs_list_item, jobs);
        ...
        private class getJobs extends AsyncTask<String, Void, Document> {
            ...
            protected void onPostExecute(Document result) {
                ...
                attachJobs(mContext, rootView);
                /* Attach the ArrayList of events to the ListView using a custom adapter */
                /*ListView jobList = (ListView) rootView.findViewById(R.id.listJobs);
                JobAdapter adapter = new JobAdapter(mContext,R.layout.jobs_list_item, jobs);
                jobList.setAdapter(adapter);*/
                /* --- */
            }
    ...
    public static class OrgsFragment extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            if(!gotOrgs) {    //Orgs not retrieved, this if statement ensures against duplication
                ...
                attachOrgs(getContext(), rootView);
            }
            gotOrgs = true;
        ...
        protected void attachOrgs(Context context, View rootView) {
            /* Attach the ArrayList of events to the ListView using a custom adapter */
            ListView orgList = (ListView) rootView.findViewById(R.id.listOrgs);
            OrganizationAdapter adapter = new OrganizationAdapter(context, R.layout.orgs_list_item, orgs);
    ...
    private class needUpdate extends AsyncTask<String, Void, Document> {
        ...
        protected void onPostExecute(Document result) {
            ...
            if(newsestCode > versionCode) { //Update Needed
                showDialog(EventsCalendar.this, R.layout.dialog_update, "Update Avaliable");
